...
<div class="splash_notice">
	<div class="splash-message">
		<div class=""><img src="<?php echo get_template_directory_uri();?>/images/logosmall.png" alt="logo" width="283" height="103" id="logo-small" /></div>	
		<p>Please view this site in landscape mode for best viewing experience.</p>
	</div>
</div>
...
jQuery(document).ready(function(){
    jQuery("#logo-small").click(function(){
        localStorage.removeItem("splashed");
        setCookie("is_splash",0);
