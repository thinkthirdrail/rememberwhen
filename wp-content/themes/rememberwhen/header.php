...
<? /* <link rel="icon" type="image/png" sizes="196x196" href="<?php echo get_bloginfo('template_url');?>/images/favicon.png"> */ ?>
<!-- <link rel="apple-touch-icon" href="<?php echo get_bloginfo('template_url');?>/images/favicon.png">
<link rel="apple-touch-startup-image" href="<?php echo get_bloginfo('template_url');?>/images/favicon.png">
<link rel="icon" href="<?php echo get_bloginfo('template_url');?>/favicon/favicon.ico" type="image/x-icon"> -->
<?php /*?><!--favicon icon-->
<link rel="icon" type="image/png" href="<?php echo get_bloginfo('template_url');?>/images/favicon.ico" /><?php */?>
